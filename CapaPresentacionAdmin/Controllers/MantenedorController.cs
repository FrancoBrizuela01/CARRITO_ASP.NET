...
namespace CapaPresentacionAdmin.Controllers
{
    ...
    public class MantenedorController : Controller
    {
        ...
        public JsonResult GuardarProducto(string objeto, HttpPostedFileBase archivoImagen)
        {
            ...
            if (decimal.TryParse(oProducto.PrecioTexto, NumberStyles.AllowDecimalPoint, new CultureInfo("es-AR"), out precio)) //convierto el precioTexto en decimal y los guardo en la variable precio
            {
